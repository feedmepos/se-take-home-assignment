import { BotIcon, FlameKindling, TimerReset } from 'lucide-react'
import {
    ...
    >
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div className="flex items-center gap-3">
          <span className="grid size-10 place-items-center rounded-md bg-red-700 text-white">
            <BotIcon aria-hidden="true" size={20} />
          </span>
          <div>
      ...
      <div className="mt-4">
        <div className="mb-2 flex items-center justify-between text-xs font-black uppercase tracking-[0.12em] text-zinc-500">
          <span className="inline-flex items-center gap-1.5">
            <FlameKindling aria-hidden="true" size={15} />
            progress
          </span>
          <span className="inline-flex items-center gap-1.5">
