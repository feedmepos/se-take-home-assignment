  ...
  return (
    <header className="flex flex-wrap items-center justify-between gap-4">
      <div className="flex items-center gap-3.5">
        <div className="grid place-items-center rounded-2xl bg-surface p-2 ring-1 ring-line/10 shadow-[0_8px_24px_-12px_rgba(255,199,44,0.4)]">
          <GoldenArches />
        </div>
        <div>
          <h1 className="font-display text-2xl font-extrabold leading-none tracking-tight text-fg md:text-3xl">
            Order Control Center
          </h1>
          <p className="mt-1 text-xs font-medium uppercase tracking-[0.25em] text-fg/40">
