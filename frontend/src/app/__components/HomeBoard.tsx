  ...
  return (
    <div className="home__board">
      <Card
        ...
        extra={<Tag color="blue">{pendingOrders.length} waiting</Tag>}
      >
      ...
      <Card
        ...
        extra={<Tag color="green">{idleBots} idle</Tag>}
      >
        {state.bots.length ? (
          state.bots.map((bot) => {
            const activeOrder =
            ...
            return (
              ...
              >
                <div className="home__bot-card-head">
                  <Space size={8} align="center">
                    <Tag color={bot.status === "WORKING" ? "volcano" : "green"}>
                      Bot #{bot.id}
                    </Tag>
      ...
      <Card
        ...
        extra={<Tag color="success">{completeOrders.length} done</Tag>}
      >
